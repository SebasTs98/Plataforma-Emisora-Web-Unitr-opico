  ...
  <!-- ======= Fin Menu======= -->
        ...
        <div class="row">
          <div class="col-lg-12 text-center mb-5">
            <h1 class="page-title" style="font-family: 'Montserrat', sans-serif;">Acerca de Nosotros</h1>
          </div>
        </div>
        ...
        <div class="row mb-5">
          ...
          <div class="d-md-flex post-entry-2 half">
            ...
            <div class="ps-md-5 mt-4 mt-md-0">
              ...
              <h2 class="mb-4 display-4" style="font-family: 'Montserrat', sans-serif;">El comienzo.</h2>
          ...
          <div class="d-md-flex post-entry-2 half mt-5">
            ...
            <div class="pe-md-5 mt-4 mt-md-0">             
              <h2 class="mb-4 display-4" style="font-family: 'Montserrat', sans-serif;">Mision &amp; Vision</h2>
        ...
        <div class="row">
          <div class="col-12 text-center mb-5">
            <div class="row justify-content-center">
              <div class="col-lg-6">
                <h2 class="display-4" style="font-family: 'Montserrat', sans-serif;">Nuestro Equipo</h2>
                <p style="font-family: 'Montserrat', sans-serif;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil sint sed, fugit distinctio ad eius itaque deserunt doloribus harum excepturi laudantium sit officiis et eaque blanditiis. Dolore natus excepturi recusandae.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 text-center mb-5">
            <img src="../assets/img/person-1.jpg" alt="" class="img-fluid rounded-circle w-50 mb-4">
            <h4 style="font-family: 'Montserrat', sans-serif;">Sebastian Torres Silva</h4>
            <span class="d-block mb-3 text-uppercase" style="font-family: 'Montserrat', sans-serif;">Ingeniero Sistemas</span>
            <p style="font-family: 'Montserrat', sans-serif;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
          </div>
          <div class="col-lg-4 text-center mb-5">
            <img src="../assets/img/person-2.jpg" alt="" class="img-fluid rounded-circle w-50 mb-4">
            <h4 style="font-family: 'Montserrat', sans-serif;">Diego Naranjo</h4>
            <span class="d-block mb-3 text-uppercase" style="font-family: 'Montserrat', sans-serif;">Diseñador Gráfico</span>
            <p style="font-family: 'Montserrat', sans-serif;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
          </div>
          <div class="col-lg-4 text-center mb-5">
            <img src="../assets/img/person-3.jpg" alt="" class="img-fluid rounded-circle w-50 mb-4">
            <h4 style="font-family: 'Montserrat', sans-serif;">Erika Serrano</h4>
            <span class="d-block mb-3 text-uppercase" style="font-family: 'Montserrat', sans-serif;">Lider de Presa y Comunicaciones</span>
            <p style="font-family: 'Montserrat', sans-serif;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, perspiciatis repellat maxime, adipisci non ipsam at itaque rerum vitae, necessitatibus nulla animi expedita cumque provident inventore? Voluptatum in tempora earum deleniti, culpa odit veniam, ea reiciendis sunt ullam temporibus aut!</p>
          </div>
