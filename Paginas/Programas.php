...
<head>
  ...
  <title>Programas Unitropìco</title>
  ...
  <!-- ======= Fin Menu======= -->
       ...
       <div class="container">
            ...
            <center>
               ...
               text-align: center;">Programas Unitrópico</h2>
            </center>
         
          <div><a href="" class="more"></a></div>
        </div>
            ...
            <div class="row">
               ...
               $query .= 'ORDER BY id DESC ';
                ...
                <div id="post-1238" class="col-sm-12 col-md-6 col-lg-4 mt-2 mb-4 post-1238 eventos type-eventos status-publish has-post-thumbnail hentry">
                    ...
                    <br>
                    <center>
                      <h4 style="font-family: 'Montserrat', sans-serif;" ><?php echo $row['nombre']; ?></h4>
                    </center>
                    <br>
                    <img src="../Administracion/Admi/Crud-PRO/upload/<?php echo $row['image']; ?>" alt="Avatar" style="width:100%">
 ...
 <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
            <h2 style="font-family: 'Montserrat', sans-serif;">Programa #<?php echo $row['id']; ?></h2> 
        </div>
        <div class="modal-body" >
            <h2 class="card-title" style="text-align: justify;"><?php echo $row['nombre']; ?></h2>
            <br>
            <center>
             <img src="../Administracion/Admi/Crud-PRO/upload/<?php echo $row['image']; ?>" alt="Avatar" style="width:100%"> 
            </center>
            ...
            <center>
            <audio controls>
            <source src="../Administracion/Admi/Crud-Pro/audios/<?php echo $row['audio']; ?>" type="audio/mp3">   
            </audio>
          </center>
            <h4 class="card-title" style="text-align: justify; font-family: 'Montserrat', sans-serif;"><?php echo $row['descripcion']; ?></h4>         <h4 class="card-title" style="text-align: justify; font-family: 'Montserrat', sans-serif;">Horario: <?php echo $row['comienzo']; ?></h4>
            <br>
            <h5 class="card-title" style="text-align: justify; font-family: 'Montserrat', sans-serif;">Elaborado por: <?php echo $row['autor']; ?></h5>
