...
<head>
  ...
  <title>Eventos Unitropìco</title>
...
<body>
  ...
  <!-- ======= Header ======= -->
<div id="pageintro" class="wrapper row1 bgded" style="heigh:665px; background-image:url('assets/img/02.png');   background-repeat: repeat-y;
  background-size: 10rem; text-align: center;">
  ...
  <!-- ======= Fin Menu======= -->
       ...
       <div class="container">
            ...
            <center>
               ...
               text-align: center;">Eventos Emisora Unitrópico</h2>
            </center>         
            ...
            <div class="row">
               ...
               $query .= 'ORDER BY id DESC ';
                                            ...
                                            while ($row = $resultado->fetch_assoc() ) 
                                             {     ?>  
              <div id="post-1238" class="col-sm-12 col-md-6 col-lg-4 mt-2 mb-4 post-1238 eventos type-eventos status-publish has-post-thumbnail hentry">
                  <div class="card bg-grey" style="height: 100%;"> 
                    <br>
                    <center>
                      <h4 style="font-family: 'Montserrat', sans-serif;" ><?php echo $row['first_name']; ?></h4>
                    </center>
                    <br>
                    
                   <a class="text-decoration-none" >
                                    <img width="302" height="271"  src="../Administracion/Admi/Crud/upload/<?php echo $row['image']; ?>" class="card-img-top mb-4 wp-post-image" alt=""  sizes="(max-width: 302px) 100vw, 302px">                 
                                   </a>
                    <br>
                    <div class="container">                   
                        <p style="font-family: 'Montserrat', sans-serif; text-align: justify;"><?php echo $row['autor']; ?></p>                     
                    </div>

                   <center>
                       <a class="text-decoration-none" href="https://ruv.unad.edu.co/ruvwp/eventos/red-de-radios-universitarias-de-colombia-rruc/">
                                    <a  class="btn btn-info btn-lg" style="background: #0071b9;" data-toggle="modal" data-target="#myModal<?php echo $row['id'];?>" >Leer Más</a>
                                </a>
                   </center>
 ...
 <!-- Modal content-->
       <div class="modal-content">
        <div class="modal-header">
               <h2 style="font-family: 'Montserrat', sans-serif;">Evento #<?php echo $row['id'];?></h2> 
        </div>
        <div class="modal-body" >
            <h2 class="card-title" style="text-align: justify;"><?php echo $row['first_name']; ?></h2>
            <br>
            <center>
             <img src="../Administracion/Admi/Crud/upload/<?php echo $row['image']; ?>" alt="Avatar" style="width:100%"> 
            </center>
            <br>
            <h4 class="card-title" style="text-align: justify; font-family: 'Montserrat', sans-serif"><?php echo $row['last_name']; ?></h4>
            <br>
            <h4 class="card-title" style="text-align: justify; font-family: 'Montserrat', sans-serif">Escrito por: <?php echo $row['autor']; ?></h4>
