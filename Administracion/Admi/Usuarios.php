...
<head>
    ...
    <title>Usuarios Unitrópico</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800" style="text-align: center;">Lista de Usuarios Unitrópico</h1>
                    <p class="mb-4"></p>
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Ingresar Usuario</h6>
                    </div>
                    
                    <div class="card-body">

                        <div align="left">
                            <a href="../../Funciones/Registrar-Usuario.php" class="btn btn-success" id="add_button" type="button" role="button" aria-pressed="true"><i class="fa fa-plus" aria-hidden="true" ></i></a>
