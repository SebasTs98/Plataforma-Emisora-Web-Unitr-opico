...
<head>
    ...
    <title>Programaciòn Unitrópico</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800" style="text-align: center;">Programación y Programas Unitrópico</h1>
                    <p class="mb-4"></p>
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Ingresar Nuevo Programa</h6>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabla de Programas</h6>
                        </div>
                        <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="file" name="audios" id="audios"  />
                     <span id="user_uploaded_audios"></span><br>
                     <br>
                    ...
                    <br />                                     
                    <label>Selecione la Hora del Programa:</label>
                    <select  name="horaI" id="horaI" class="form-control" >
                      ...
                      <option value="11:00 AM - 12:00 PM">11:00 AM - 12:00 AM</option>
                      ...
                      <option value="12:00 AM - 06:00 AM">12:00 AM - 06:00 AM</option>
