        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800" style="text-align: center;">Multimedia Unitópico</h1>
                    <p class="mb-4"></p>
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Ingresar Url video Youtube</h6>
                    </div>
...
-->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabla de Videos de Youtube</h6>
                        </div>
        ...
        <form method="post" id="user_form" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Agregar Url Youtube</h4>
                </div>
                <!-- banner -->
...
$(document).ready(function(){
    $('#add_button').click(function(){
        $('#user_form')[0].reset();
        $('.modal-title').text("Agregar Url Youtube");
        $('#action').val("Guardar");
        $('#operation').val("Add");
    ...
    $(document).on('click', '.update', function(){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                $('#url').val(data.url);                           
                $('.modal-title').text("Editar Url Youtube");
                $('#user_id').val(user_id);
