...
if($email != false && $password != false){
    ...
    if($run_Sql){
        ...
        if($status == "verified"){
            if($code != 0){
                header('Location: ../../Funciones/Restablecer_Codigo.php');
            }
        }else{
         
            header('Location: ../../Funciones/Usuario-otp.php');
        }
    }
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="font-family: 'Montserrat', sans-serif;">BIENVENIDO ADMINISTRADOR</h1>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Eventos</div>
                                           <a href="Eventos.php" type="button" class=" btn btn-primary">Ingresar</a>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Programación</div>
                                                <a href="Programacion.php" type="button" class=" btn btn-primary">Ingresar</a>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Podcast
                                               
                                            </div> <a href="Podcast.php" type="button" class=" btn btn-primary">Ingresar</a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Peticiones</div>
                                                 <a href="Peticiones.php" type="button" class=" btn btn-primary">Ingresar</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto" style="font-family: 'Montserrat', sans-serif;">
                        <span>Copyright &copy; Emisora Unitropíco 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
