...
<html lang="en">
<head>
    <title>Verificaciòn de Correo</title>
    <meta charset="UTF-8">
    ...
    <div class="limiter">
        <div class="container-login100">
            ...
            <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                <form action="Usuario-otp.php" method="post" class="login100-form validate-form">

                    <span class="login100-form-title p-b-59">
                       Verificaciòn de Correo
                    </span>
                    <?php 
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Solo es valido el codigo del correo">
                        <span class="label-input100">Codigo</span>
                        <input class="input100" type="number" name="otp" placeholder="Ingrese Codigo de Verificaciòn">
                    ...
                    <div class="container-login100-form-btn">
                        <a href="sesion.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
                            ...
                            <button 
                            input type="submit" class="login100-form-btn" name="check" value="Verificar">  <!-- validacion de los datos -->
                            Verificar
                            </button>
                        </div>
                    <div>
